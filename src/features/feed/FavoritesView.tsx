  ...
  return (
    <div id="kid-favorites-view" className="space-y-6">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-yt-surface/95 p-4 sm:p-5 rounded-3xl border border-rose-100 shadow-[0_2px_12px_rgba(244,63,94,0.05)]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base sm:text-lg font-black text-yt-text flex items-center gap-2">
      ...
      {filteredFavorites.length === 0 ? (
        debouncedSearch ? (
          <div className="max-w-lg mx-auto my-6 px-4">
            <div className="bg-yt-surface/90 rounded-3xl border border-rose-100 p-8 text-center space-y-4 shadow-sm">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-yt-text-muted max-w-md mx-auto font-medium">
          ...
          >
            <div className="bg-yt-surface/90 rounded-3xl border border-rose-100 p-8 sm:p-10 text-center space-y-4 shadow-sm flex flex-col items-center">
              ...
              <div className="space-y-1.5 max-w-md mx-auto">
                ...
                <p className="text-xs sm:text-sm text-yt-text-muted leading-relaxed font-medium">
              ...
              <button
                ...
                type="button"
                onClick={onCloseFavorites}
                className="px-6 py-2.5 rounded-full bg-yt-brand hover:bg-yt-brand-hover text-yt-brand-text text-xs sm:text-sm font-bold transition shadow-sm cursor-pointer active:scale-95 flex items-center gap-1.5"
              >
                <ArrowRight className="w-4 h-4" />
                <span>العودة للفيديوهات</span>
              </button>
